...
image topic and are optional. The dialog core runs without them.
...
| --- | --- |
| `emotion_detector` | Detects a face and classifies emotion (Hugging Face pipeline) and publishes JSON. |
